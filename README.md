...
race condition, a Mutex-like design is implemented to regulate asynchrounous functions and soft kill. Although unfinished, it can still operate basic tasks such as initiating, transitioning state-to-state and
